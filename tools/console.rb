...
startup1 = Startup.new(startups.sample, founders.sample, "tech" )
startup2 = Startup.new(startups.sample, founders.sample, "tech" )
...
startup7 = Startup.new(startups.sample, founders.sample, "tech" )
...
fund2 = startup2.sign_contract(vencap1, funding.sample, investment)
fund21 = startup7.sign_contract(vencap1, funding.sample, investment)
